...
//
//    @Test(priority = 34)
//    public void verifyClickingOnOKButtonRedirectToOrderSuccessfullScreen(){
//        Assert.assertTrue(bankPaymentScreenPage.verifyIfClickingOnOKButtonRedirectToOrderSuccessfullScreen());
//    }
